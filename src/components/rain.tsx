...
const Rain: React.FC = () => {
    ...
    const handleWindSpeedChange = (e: React.ChangeEvent<HTMLInputElement>): void => {
    ...
    return (
        ...
        >
            <div
                ...
                style={{
                    background: 'linear-gradient(to bottom, rgba(194, 65, 12, 0.1), rgba(88, 28, 135, 0.05), transparent)'
                }}
            />
